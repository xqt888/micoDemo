...
import { Tab,Radio,Checkbox,Grid,NumberPicker,Select} from '@alifd/next';
...
class CRON extends React.Component {
  ...
  onSecondRadioChange = (value) => {
    const SecondRadiochecked =value;
  ...
  // ---------------------------------------分-------------------------------------------------------------------------------------
  // CRON-分钟-radio选择回调
  onMinuteRadioChange = (value) => {
    const minuteRadiochecked = value;
  ...
  // ---------------------------------------时-------------------------------------------------------------------------------------
  // CRON-小时-radio选择回调
  onHourRadioChange = (value) => {
    const hourRadiochecked = value;
  ...
  // ---------------------------------------日-------------------------------------------------------------------------------------
  // CRON-日-radio选择回调
  onDaysRadioChange = (value) => {
    const daysRadiochecked = value;
  ...
  // ---------------------------------------月-------------------------------------------------------------------------------------
  // CRON-月-radio选择回调
  onMonthRadioChange = (value) => {
    const monthRadiochecked = value;
  ...
  // CRON-周-radio选择回调
  onWeekRadioChange = (value) => {
    const weekRadiochecked = value;
  ...
  // CRON-年-radio选择回调
  onYearRadioChange = (value) => {
    const yearRadiochecked =value;
  ...
  render() {
    ...
    return (
      <div className={Cls} style={style}>
        <Tab defaultActiveKey={String(TabsActiveKey)} onChange={this.callback}>
          {
              this.isShowDom('second', type) &&
              <TabPane title={i18n.second} key="1">
                <RadioGroup name="radiogroup" value={SecondRadiochecked} onChange={this.onSecondRadioChange}>
                  ...
                  <Radio style={radioStyle} value={2}>
                    {i18n.from} <NumberPicker disabled={SecondRadiochecked !== 2} min={0} max={59} value={secondCycleStart} type="inline" onChange={this.secondCycleStart} style={{ width: 96 }} />
                    &nbsp;到 <NumberPicker disabled={SecondRadiochecked !== 2} min={0} max={59} value={secondCycleEnd} type="inline" onChange={this.secondCycleEnd} style={{ width: 96 }} /> {i18n.second1}
                  </Radio>
                  <Radio style={radioStyle} value={3}>
                    {i18n.from} <NumberPicker disabled={SecondRadiochecked !== 3} min={0} max={59} value={secondStart} type="inline" onChange={this.secondStart} style={{ width: 96 }} /> {i18n.secondstart}
                    {i18n.Every} <NumberPicker disabled={SecondRadiochecked !== 3} min={0} max={59} value={secondEvery} type="inline" onChange={this.secondEvery} style={{ width: 96 }} /> {i18n.second1}{i18n.doOne}
                  </Radio>
                  <Radio style={radioStyle} value={4}>{i18n.appoint}
                  {/* &nbsp; &nbsp;
                  <Select
                   mode="multiple" 
                   followTrigger
                  ...
                  <br />
                    <CheckboxGroup value={secondChecked.split(',')} style={{ width: '100%' }} onChange={this.onSecndcheckChange} >
                      <Row
                       wrap={true}
                      justify={"left"}
                      > {this.createChecks(options, SecondRadiochecked, 4)} </Row>
                    </CheckboxGroup>
                  </Radio>
                </RadioGroup>
              </TabPane>
          }
          {
            ...
            <TabPane title={i18n.minute} key="2">
              <RadioGroup name="radiogroup" value={minuteRadiochecked} onChange={this.onMinuteRadioChange}>
                ...
                <Radio style={radioStyle} value={2}>
                  {i18n.from} <NumberPicker disabled={minuteRadiochecked !== 2} min={0} max={59} value={minuteCycleStart} type="inline" onChange={this.minuteCycleStart} style={{ width: 96 }} />
                    &nbsp;到 <NumberPicker disabled={minuteRadiochecked !== 2} min={0} max={59} value={minuteCycleEnd} type="inline" onChange={this.minuteCycleEnd} style={{ width: 96 }} /> {i18n.minute1}
                </Radio>
                <Radio style={radioStyle} value={3}>
                  {i18n.from} <NumberPicker disabled={minuteRadiochecked !== 3} min={0} max={59} value={minuteStart} type="inline" onChange={this.minuteStart} style={{ width: 96 }} /> {i18n.minutestart}
                  {i18n.Every} <NumberPicker disabled={minuteRadiochecked !== 3} min={0} max={59} value={minuteEvery} type="inline" onChange={this.minuteEvery} style={{ width: 96 }} /> {i18n.minute1}{i18n.doOne}
                </Radio>
                <Radio style={radioStyle} value={4}>{i18n.appoint}<br />
                  <CheckboxGroup value={minuteChecked.split(',')} style={{ width: '100%' }} onChange={this.onMinuteCheckChange} >
                    <Row
                      wrap={true}
                      justify={"left"}
                    > {this.createChecks(options, minuteRadiochecked, 4)} </Row>
                  </CheckboxGroup>
                </Radio>
              </RadioGroup>
            </TabPane>
          }
          {
            ...
            <TabPane title={i18n.hour} key="3">
              <RadioGroup name="radiogroup" value={hourRadiochecked} onChange={this.onHourRadioChange}>
                ...
                <Radio style={radioStyle} value={2}>
                  {i18n.from} <NumberPicker disabled={hourRadiochecked !== 2} min={0} max={23} value={hourCycleStart} type="inline" onChange={this.hourCycleStart} style={{ width: 96 }} />
                    &nbsp;到 <NumberPicker disabled={hourRadiochecked !== 2} min={0} max={23} value={hourCycleEnd} type="inline" onChange={this.hourCycleEnd} style={{ width: 96 }} /> {i18n.hour1}
                </Radio>
                <Radio style={radioStyle} value={3}>
                  {i18n.from} <NumberPicker disabled={hourRadiochecked !== 3} min={0} max={23} value={hourStart} type="inline" onChange={this.hourStart} style={{ width: 96 }} /> {i18n.hourstart}
                  {i18n.Every} <NumberPicker disabled={hourRadiochecked !== 3} min={0} max={23} value={hourEvery} type="inline" onChange={this.hourEvery} style={{ width: 96 }} /> {i18n.hour1}{i18n.doOne}
                </Radio>
                <Radio style={radioStyle} value={4}>{i18n.appoint}<br />
                  <CheckboxGroup value={hourChecked.split(',')} style={{ width: '100%' }} onChange={this.onHourCheckChange} >
                    <Row
                      wrap={true}
                      justify={"left"}
                    > {this.createChecks(hourOptions, hourRadiochecked, 4)} </Row>
                  </CheckboxGroup>
                </Radio>
              </RadioGroup>
            </TabPane>
          }
          {
            ...
            <TabPane title={i18n.day} key="4">
              <RadioGroup name="radiogroup" value={daysRadiochecked} onChange={this.onDaysRadioChange}>
                ...
                <Radio style={radioStyle} value={3}>
                  {i18n.from} <NumberPicker disabled={daysRadiochecked !== 3} min={1} max={31} value={daysCycleStart} type="inline" onChange={this.daysCycleStart} style={{ width: 96 }} />
                    &nbsp;到 <NumberPicker disabled={daysRadiochecked !== 3} min={1} max={31} value={daysCycleEnd} type="inline" onChange={this.daysCycleEnd} style={{ width: 96 }} /> {i18n.day1}
                </Radio>
                <Radio style={radioStyle} value={4}>
                  {i18n.from} <NumberPicker disabled={daysRadiochecked !== 4} min={1} max={31} value={daysStart} type="inline" onChange={this.daysStart} style={{ width: 96 }} /> {i18n.daystart}
                  {i18n.Every} <NumberPicker disabled={daysRadiochecked !== 4} min={1} max={31} value={daysEvery} type="inline" onChange={this.daysEvery} style={{ width: 96 }} /> {i18n.day1}{i18n.doOne}
                </Radio>
                {/* <Radio style={radioStyle} value={5}>
                  {i18n.Everymonth1} <NumberPicker disabled={daysRadiochecked !== 5} min={1} max={31} value={daysForWorking}  onChange={this.daysForWorking} style={{ width: 100 }} /> {i18n.latestDays}
                </Radio>
                ...
                <Radio style={radioStyle} value={7}>{i18n.appoint}<br />
                  <CheckboxGroup value={daysChecked.split(',')} style={{ width: '100%' }} onChange={this.onDaysCheckChange} >
                    <Row
                      wrap={true}
                      justify={"left"}
                    > {this.createChecks(daysForMonOptions, daysRadiochecked, 7)} </Row>
                  </CheckboxGroup>
                </Radio>
              </RadioGroup>
            </TabPane>
          ...
          this.isShowDom('month', type) &&
            <TabPane title={i18n.month} key="5">
              <RadioGroup name="radiogroup" style={{width:"100%"}} value={monthRadiochecked} onChange={this.onMonthRadioChange}>
                <Radio style={radioStyle} value={1}>{i18n.Everymonth}</Radio>
                {/* <Radio style={radioStyle} value={2}>不指定</Radio> */}
                <Radio style={radioStyle} value={3}>
                  {i18n.from} <NumberPicker disabled={monthRadiochecked !== 3} min={1} max={12} value={monthCycleStart} type="inline" onChange={this.monthCycleStart} style={{ width: 96 }} />
                    &nbsp;到 <NumberPicker disabled={monthRadiochecked !== 3} min={1} max={12} value={monthCycleEnd} type="inline" onChange={this.monthCycleEnd} style={{ width: 96 }} /> {i18n.month1}
                </Radio>
                <Radio style={radioStyle} value={4}>
                  {i18n.from} <NumberPicker disabled={monthRadiochecked !== 4} min={1} max={12} value={monthStart} type="inline" onChange={this.monthStart} style={{ width: 96 }} /> {i18n.monthstart}
                  {i18n.Every} <NumberPicker disabled={monthRadiochecked !== 4} min={1} max={12} value={monthEvery} type="inline" onChange={this.monthEvery} style={{ width: 96 }} /> {i18n.month1}{i18n.doOne}
                </Radio>
                <Radio style={radioStyle} value={5}>{i18n.appoint}<br />
                  <CheckboxGroup value={monthChecked.split(',')} style={{ width: '100%' }} onChange={this.onMonthCheckChange} >
                    <Row
                      wrap={true}
                      justify={"left"}
                    > {this.createChecks(monthOptions, monthRadiochecked, 5)} </Row>
                  </CheckboxGroup>
                </Radio>
              </RadioGroup>
            </TabPane>
          ...
          this.isShowDom('week', type) &&
            <TabPane title={i18n.week} key="6">
              <RadioGroup name="radiogroup" style={{width:"100%"}} value={weekRadiochecked} onChange={this.onWeekRadioChange}>
                <Radio style={radioStyle} value={1}>{i18n.Everyweek}</Radio>
                <Radio style={radioStyle} value={2}>{i18n.noappoint}</Radio>
                <Radio style={radioStyle} value={3}>
                  {i18n.from}{i18n.week1} <Select followTrigger disabled={weekRadiochecked !== 3} value={weekCycleStart}  onChange={this.weekCycleStart} style={{ width: 100 }}>
                    {children}
                                            </Select>
                    &nbsp;- <Select followTrigger disabled={weekRadiochecked !== 3} value={weekCycleEnd} onChange={this.weekCycleEnd} style={{ width: 100 }}>
                      {children}
                    </Select>
                </Radio>
                <Radio style={radioStyle} value={4}>
                  {i18n.monthweek} <NumberPicker disabled={weekRadiochecked !== 4} min={1} max={5} value={weekStart} type="inline"  onChange={this.weekStart} style={{ width: 96 }} /> {i18n.week3}
                  {i18n.week2} <Select followTrigger disabled={weekRadiochecked !== 4} value={weekEvery}  onChange={this.weekEvery} style={{ width: 100 }} >
                    {children}
                               </Select>
                </Radio>
                <Radio style={radioStyle} value={5}>{i18n.weekend} <Select followTrigger disabled={weekRadiochecked !== 5} value={weekEnd}  onChange={this.changeweekEnd} style={{ width: 100 }} >
                  {children}
                                                                   </Select>
                </Radio>
                <Radio style={radioStyle} value={6}>{i18n.appoint}<br />
                  <CheckboxGroup value={weekChecked.split(',')} style={{ width: '100%' }} onChange={this.onWeekCheckChange} >
                    <Row
                      wrap={true}
                      justify={"left"}
                    > {this.createChecks(weekOptions, weekRadiochecked, 6)} </Row>
                  </CheckboxGroup>
                </Radio>
              </RadioGroup>
            </TabPane>
          }
          {/* <TabPane title="年" key="7">
            <RadioGroup name="radiogroup" defaultValue={1} onChange={this.onYearRadioChange}>
              ...
              <Radio style={radioStyle} value={3}>
                  {i18n.from} <NumberPicker type="number" type="inline" onChange={this.yearCycleStart} style={{ width: 100 }} />
                  - <NumberPicker type="inline" type="number" onChange={this.yearCycleEnd} style={{ width: 100 }} />
              </Radio>
            </RadioGroup>
          </TabPane> */}
        </Tab>
